...
<script setup>
 ...
 useSeoMeta({
     ...
     ogDescrition: recipe?.description,
 })
 ...
 // You can see field needed for (Recipe here)
 // https://schema.org/Recipe
 // cookTime Nutrition, prepTime, etc...
 useSchemaOrg([
     defineRecipe({
         name: recipe?.title,
         description: recipe?.description,
         ...
         recipeYield: recipe?.recipeYield, // quantity e.g: 3 servings
         ...
         recipeInstructions: recipe?.recipeInstructions // Array of Objects with instructions
     })
 ])
 // You can validate your schema here: https://validator.schema.org/
</script>
